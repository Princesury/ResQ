  ...
  const renderItem = ({item}) => {
    return(
      ...
      <View style={{marginBottom:10,marginLeft:5,flexDirection:'row',backgroundColor:'#fff'}}>
        <Image source={require('../img/emergency.jpg')} style={{height:75,width:75,margin:10,borderRadius:10}}/>
        <View style={{flexDirection:'column'}}>
        <Text style={{fontSize:15,fontWeight:'500',margin:5,width:250,marginTop:10}}>{item.title}</Text>
